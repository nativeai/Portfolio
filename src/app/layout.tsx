      ...
      <body className="bg-fixed bg-gradient-to-r from-beige-200 to-blue dark:from-dark-500 dark:to-dark-700 dark:text-white">
        <ThemeProvider attribute="class">
          ...
          <div className="grid grid-cols-12 gap-6 px-5 my-14 lg:mb-0 md:mb-16 sm:px-20 md:px-32 lg:px-36 xl:px-48">
            <div className="hover:scale-100 h-full md:max-h-screen col-span-12 p-6 text-base text-center bg-white/90 dark:bg-dark-500/90 lg:col-span-3 rounded-md shadow-custom-light dark:shadow-custom-dark backdrop-blur-sm overflow-hidden">
              <Sidebar />
            </div>
